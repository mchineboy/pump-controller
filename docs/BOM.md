...
| Enclosure | Controller enclosure | Ventilated enclosure for ESP32, driver, buck converter, terminals, and optional valve driver; print from [cad/enclosure/](../cad/enclosure/) (v1 or v2) | 1 | Recommended | **PETG**; keep liquid plumbing physically separated from electronics |
